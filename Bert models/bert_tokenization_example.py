...
#Encode the sentence into token ids using the tokenizer
...
#Zip tokens and token_ids (excluding the first and last token ids for [CLS] and [SEP])
...
#Tokenize the sentence using the tokenizer's_call_" method
...
#Decode the tokenized input ids for both sentencesT
